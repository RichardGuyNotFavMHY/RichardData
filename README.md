...
**更新**：网盘已经筹备成功，您现在可以访问[这个MEGA网盘](https://mega.nz/folder/cvkXjCTZ#BDaj3xxqBca6y9Suszj6Eg)获取无图片版本的理查备份。  
**如果您需要有图片版本的备份，请直接在该项目内发issues**  
**由于导出错误等原因，index和Data并不能完全一一对应，但这并不代表那些信息没有保存，对于不在列表上的信息，您可以直接发issues问询**  
### 这是什么？这个项目怎么来的？(高可读)
这是一个自动记录里茶馆内所有发帖、回帖数据的项目。该项目的数据来源于一些自动化的魔法，关注结果即可。
### 这个项目是如何组织文件的？我该如何使用这个项目？
### 如何组织文件
本项目有用的东西是一个文件(index.csv)和一个压缩文件(Data.7z，在MEGA网盘)。  
...
### 如何使用本项目的数据
0. 请准备一个**markdown阅读器**。
1. 请完全下载本项目的index.csv与Data.7z文件。(Data文件夹内的信息受限于存储大小，已经停止维护。最新信息请查看Data.7z，在MEGA网盘(230915))
